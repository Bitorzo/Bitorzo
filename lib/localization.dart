...
class AppLocalization {
  ...
  String get sent_unconfirmed {
    return Intl.message('Sent\n(unconfirmed)',
        desc: 'history_sent_unconfirmed', name: 'sent_unconfirmed');
  }

  String get received_unconfirmed {
    return Intl.message('Received\n(unconfirmed)',
        desc: 'history_received_unconfirmed', name: 'received_unconfirmed');
  }
  ...
  String get unconfirmed {
    return Intl.message('unconfirmed',
        desc: 'uncofirmed_text', name: 'unconfirmed');
  }
  ...
  String get phoneHint {
    return Intl.message('Enter Phone Number',
        desc: 'send_phone_hint', name: 'phoneHint');
  }
  ...
  String get tempUnsupported {
    return Intl.message("Temporarily Unsupported feature (privacy)",
        desc: 'temp_unspported', name: 'tempUnsupported');
  }
  ...
  String get contactNotMember {
    return Intl.message("Invite this contact to join Bitorzo!",
        desc: 'contact_not_member', name: 'contactNotMember');
  }
  ...
  String get welcomeText {
    return Intl.message("Welcome to Bitorzo. To begin, you may create a new wallet or import an existing one.",
  ...
  String get requestConfirmation {
    return Intl.message("Request confirmation\n (recommended)",
  ...
  String get noPulicKeysAvailableForContact {
    return Intl.message("No public keys available for contact",
        desc: 'no_public_keys_available_for_contact', name: 'noPulicKeysAvailableForContact');
  }

  String get noChangeKeyAvailable {
    return Intl.message("No change key available",
        desc: 'no_change_key_available', name: 'noChangeKeyAvailable');
  }

  String get estimatedFees {
    return Intl.message(" mBTC network fees",
        desc: 'estimated_fees', name: 'estimatedFees');
  }
  ...
  String get invalidPhone {
    return Intl.message("Phone entered was invalid",
        desc: 'send_invalid_phone', name: 'invalidPhone');
  }
  ...
  String get shareBitorzo {
    return Intl.message("Share Bitorzo",
      desc: 'settings_share', name: 'shareBitorzo');
  }

  String get shareBitorzoText {
    return Intl.message("Check out Bitorzo! A premier Bitcoin mobile wallet!",
      desc: 'share_extra', name: 'shareBitorzoText');
  }
  ...
  String get receive_confirmation {
    return Intl.message("Receive Confirmation",
        desc: 'receeive_confirmation', name: 'receiveConfirmation');
  }

  String get logoutDetail {
    return Intl.message("Logging out will remove your seed and all Bitcoin-related data from this device. If your seed is not backed up, you will never be able to access your funds again",
  ...
  String get notificationTitle {
    return Intl.message("Received %1 BTC",
      desc: 'notification_title', name: 'notificationTitle');
  }

  String get notificationBody {
    return Intl.message("Open Bitorzo to view this transaction",
  ...
  String get kaliumWallet {
    return Intl.message("Bitorzo Wallet",
  ...
  String get transferIntro {
    return Intl.message("This process will transfer the funds from a paper wallet to your Bitorzo wallet.\n\nTap the \"%1\" button to start.",
      desc: 'transfer_intro', name: 'transferIntro');
  }

  String get transferQrScanHint {
    return Intl.message("Scan a BTC \nseed or private key",
  ...
  String get receive_confirmation_intent {
    return Intl.message('requests to send',
        desc: "Shown to users upon recieve confimration request", name: 'receiveConfirmationIntent');
  }

  String get receive_confirmation_intent_2 {
    return Intl.message('to your wallet',
        desc: "Shown to users upon recieve confimration request", name: 'receiveConfirmationIntent2');
  }

  String get receive_confirmation_security_clarification {
    return Intl.message('(Your recieve address was verified by your Bitorzo wallet)',
        desc: "Shown to users upon recieve confimration request", name: 'receiveConfirmationSecurityVerification');
  }

  // Compelte screen

  String get transferComplete {
    return Intl.message("%1 BTC successfully transferred to your Bitorzo Wallet.\n",
  ...
  String get unlockPin {
    return Intl.message("Enter PIN to Unlock Bitorzo",
      desc: 'unlock_kalium_pin', name: 'unlockPin');
  }

  String get unlockBiometrics {
    return Intl.message("Authenticate to Unlock Bitorzo",
  ...
  String get exampleCardIntro {
    return Intl.message(" to Bitorzo. Once you receive BTC, transactions will show up like this:",
  ...
  String get newAccountIntro {
    return Intl.message("This is your new account. Once you receive BTC, transactions will show up like this:",
  ...
  String get passwordWillBeRequiredToOpenParagraph {
    return Intl.message("This password will be required to open BitorZo.",
      desc: 'A paragraph that tells the users that the created password will be required to open BitorZo.', name: 'passwordWillBeRequiredToOpenParagraph');
  }

  String get passwordNoLongerRequiredToOpenParagraph {
    return Intl.message("You will not need a password to open BitorZo anymore.",
      desc: 'An info paragraph that tells the user a password will no longer be needed to open BitorZo', name: 'passwordNoLongerRequiredToOpenParagraph');
  }
  ...
  String get requireAPasswordToOpenHeader {
    return Intl.message("Require a password to open Bitorzo?",
      desc: 'A paragraph that asks the users if they would like a password to be required to open BitorZo.', name: 'requireAPasswordToOpenHeader');
  }
  /// HEADERS END
  ...
  String get connectingHeader {
    return Intl.message(
        "Connecting",
        desc:
            'A header to let the user now that BitorZo is currently connecting to (or loading) live chat.',
  ...
  String get privacyUrl {
    ...
    return 'https://www.privacypolicygenerator.info/live.php?token=k3mZz6h5RnVdIIMdFdPxFwD05ISRMeti';
  }
