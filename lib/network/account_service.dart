...
import 'package:bitorzo_wallet_flutter/network/model/request/account_info_request.dart';
import 'package:bitorzo_wallet_flutter/network/model/request/block_info_request.dart';
import 'package:bitorzo_wallet_flutter/network/model/response/account_info_response.dart';
...
import 'package:bitorzo_wallet_flutter/model/state_block.dart';
import 'package:bitorzo_wallet_flutter/network/model/base_request.dart';
import 'package:bitorzo_wallet_flutter/network/model/request_item.dart';
...
import 'package:bitorzo_wallet_flutter/network/model/request/accounts_balances_request.dart';
import 'package:bitorzo_wallet_flutter/network/model/request/pending_request.dart';
import 'package:bitorzo_wallet_flutter/network/model/request/process_request.dart';
import 'package:bitorzo_wallet_flutter/network/model/response/account_history_response.dart';
import 'package:bitorzo_wallet_flutter/network/model/response/block_info_item.dart';
...
import 'package:bitorzo_wallet_flutter/network/model/response/price_response.dart';
...
class AccountService {
  ...
  Future<void> _onMessageReceived(dynamic message) async {
    ...
    await _lock.synchronized(() async {
      ...
      } else if (msg.containsKey("unconfirmed")) {
        UnconfirmedResponse resp = UnconfirmedResponse.fromJson(msg);
        EventTaxiImpl.singleton().fire(UnconfirmedEvent(response: resp));
      }
      return;
    });
  }
  ...
  Future<UtxosForTxResponse> requestUtxosForTX({String account, String amount}) async {
    UtxosForTxRequest request = UtxosForTxRequest(
        account: account,
        amount: amount
    );
    ...
    return UtxosForTxResponse.fromJson(response);
  }

  Future<UnconfirmedResponse> requestAccountUnconfirmed(String account, { int count = 1}) async {
    AccountUnconfirmedRequest request = AccountUnconfirmedRequest(
        account: account,
        count: count
    );
    dynamic response = await makeHttpRequest(request);
    ...
    return UnconfirmedResponse.fromJson(response);
  }
