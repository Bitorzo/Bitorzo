...
class AppStyles {
  ...
  static TextStyle textStyleParagraph1(BuildContext context) {
    return TextStyle(
        fontFamily: "NunitoSans",
        fontSize: AppFontSizes.medium,
  ...
  // Green primary button
  static TextStyle textStyleButtonPrimaryRed(BuildContext context) {
    return TextStyle(
        fontFamily: "NunitoSans",
        fontSize: AppFontSizes._large,
        fontWeight: FontWeight.w700,
        color: StateContainer.of(context).curTheme.cancel);
  }
