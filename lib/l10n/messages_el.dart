...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "exampleCardIntro" : MessageLookupByLibrary.simpleMessage("Καλωσήρθατε στο Bitorzo. Μόλις λάβετε mBTC, οι συναλλαγές θα εμφανιστούν ως εξής:"),
    ...
    "notificationTitle" : MessageLookupByLibrary.simpleMessage("Λήφθηκαν %1 mBTC"),
    ...
    "sendAmountConfirm" : MessageLookupByLibrary.simpleMessage("Να σταλθούν %1 mBTC?"),
    ...
    "shareKalium" : MessageLookupByLibrary.simpleMessage("Κοινοποιήστε το Bitorzo"),
    "shareKaliumText" : MessageLookupByLibrary.simpleMessage("Δοκιμάστε το Bitorzo! Το καλύτερο πορτοφόλι για BTC σε κινητά τηλέφωνα!"),
    ...
    "welcomeText" : MessageLookupByLibrary.simpleMessage("Καλωσήρθατε στο Bitorzo. Για να συνεχίσετε, μπορείτε να δημιουργήσετε ένα νέο πορτοφόλι ή να εισάγετε ένα υπάρχον."),
