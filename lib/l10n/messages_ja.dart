...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "passwordNoLongerRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("Bitorzoを開く際にパスワードを必要としなくなります。"),
    "passwordWillBeRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("このパスワードはBitorzoを開く際に必要となります。"),
    ...
    "requireAPasswordToOpenHeader" : MessageLookupByLibrary.simpleMessage("Bitorzoを開く際にパスワードを要求しますか?"),
    ...
    "shareBitorzo" : MessageLookupByLibrary.simpleMessage("Bitorzoを共有する"),
    "shareBitorzoText" : MessageLookupByLibrary.simpleMessage("優秀なナノモバイルウォレットであるナトリアムを使ってみましょう。"),
    ...
    "transferIntro" : MessageLookupByLibrary.simpleMessage("このプロセスにより、資金がペーパーウォレットからBitorzoウォレットに転送されます。\n \n「％1」ボタンをタップして開始します。"),
