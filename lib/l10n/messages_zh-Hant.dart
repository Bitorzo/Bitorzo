...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "createAPasswordHeader" : MessageLookupByLibrary.simpleMessage("建立一個密碼。"),
    "createPasswordFirstParagraph" : MessageLookupByLibrary.simpleMessage("您可建立一個密碼以強化錢包的安全。"),
    ...
    "exampleCardIntro" : MessageLookupByLibrary.simpleMessage("歡迎來到 Bitorzo。當您收到或發送 NANO 時，交易將顯示如下："),
    ...
    "logoutDetail" : MessageLookupByLibrary.simpleMessage("本動作會刪除您在本裝置裡頭的種子及所有和 Bitorzo 有關的資料。如果您的種子沒有備份，您將永遠無法存取您的帳戶"),
    ...
    "passwordNoLongerRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("您日後啟動 Bitorzo 時不用輸入密碼。"),
    "passwordWillBeRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("以後需要這個密碼方可開啟 Bitorzo。"),
    ...
    "qrInvalidPermissions" : MessageLookupByLibrary.simpleMessage("請允許相機來掃描二維條碼"),
    ...
    "requireAPasswordToOpenHeader" : MessageLookupByLibrary.simpleMessage("需要密碼才可開啟 Bitorzo 嗎？"),
    "rootWarning" : MessageLookupByLibrary.simpleMessage("您的裝置似乎已越獄或被修改，從而存在安全疑慮。建議您在繼續之前，將裝置還原至初始狀態。"),
    ...
    "secretWarning" : MessageLookupByLibrary.simpleMessage("若您的手機遺失或卸載本程式，就需要你的種子或秘密詞語才可重新處理您的資產！"),
    ...
    "shareBitorzo" : MessageLookupByLibrary.simpleMessage("分享 Bitorzo"),
    "shareBitorzoText" : MessageLookupByLibrary.simpleMessage("請試試 Bitorzo —— 針對行動裝置的 NANO 錢包！"),
    ...
    "transferComplete" : MessageLookupByLibrary.simpleMessage("%1 NANO 順利移轉到您的 Bitorzo 錢包。\n"),
    ...
    "transferIntro" : MessageLookupByLibrary.simpleMessage("這過程會將紙錢包的資產移轉至您的 Bitorzo 錢包。\n\n輕觸 \"%1\" 按鈕開始。"),
    ...
    "unlockBiometrics" : MessageLookupByLibrary.simpleMessage("經由生物辨識解鎖 Bitorzo"),
    "unlockPin" : MessageLookupByLibrary.simpleMessage("請輸入識別碼以解鎖 Bitorzo"),
    ...
    "welcomeText" : MessageLookupByLibrary.simpleMessage("歡迎來到 Bitorzo。接著您可建立新錢包或匯入現有錢包"),
