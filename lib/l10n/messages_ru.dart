...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "exampleCardIntro" : MessageLookupByLibrary.simpleMessage("Добро пожаловать в Bitorzo.Когда вы получите или отправите NANO,это будет отображено ниже."),
    ...
    "logoutDetail" : MessageLookupByLibrary.simpleMessage("Выход из системы приведёт к удалению Seed и всех связанных с Bitorzo данных с этого устройства.Если ваш Seed не будет скопирован,вы больше никогда не сможете получить доступ к своим средствам."),
    ...
    "notificationBody" : MessageLookupByLibrary.simpleMessage("Откройте Bitorzo для просмотра."),
    "notificationHeaderSupplement" : MessageLookupByLibrary.simpleMessage("Нажмите чтобы открыть"),
    "notificationTitle" : MessageLookupByLibrary.simpleMessage("Получено %1 mBTC"),
    ...
    "passwordNoLongerRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("Вам больше не понадобится пароль, чтобы открыть Bitorzo."),
    "passwordWillBeRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("Этот пароль потребуется для открытия Bitorzo."),
    ...
    "requireAPasswordToOpenHeader" : MessageLookupByLibrary.simpleMessage("Требуется пароль для открытия Bitorzo?"),
    ...
    "sendAmountConfirm" : MessageLookupByLibrary.simpleMessage("Отправить %1 mBTC"),
    ...
    "shareBitorzo" : MessageLookupByLibrary.simpleMessage("Поделиться Bitorzo"),
    "shareBitorzoText" : MessageLookupByLibrary.simpleMessage("Оцените Bitorzo! Лучший Android кошелёк BTC!"),
    ...
    "transferComplete" : MessageLookupByLibrary.simpleMessage("%1 NANO успешно переведены в Bitorzo кошелёк.\n"),
    ...
    "transferIntro" : MessageLookupByLibrary.simpleMessage("Этот процесс переведёт средства с бумажного кошелька на ваш Bitorzo кошелёк.\n\nНажмите кнопку \"%1\" чтобы начать."),
    ...
    "transferQrScanHint" : MessageLookupByLibrary.simpleMessage("Сканировать BTC \nseed или закрытый ключ"),
    "unlock" : MessageLookupByLibrary.simpleMessage("Открыть"),
    "unlockBiometrics" : MessageLookupByLibrary.simpleMessage("Аутентификация для разблокировки Bitorzo"),
    "unlockPin" : MessageLookupByLibrary.simpleMessage("Введите PIN , для разблокировки Bitorzo"),
    ...
    "welcomeText" : MessageLookupByLibrary.simpleMessage("Добро пожаловать в Bitorzo. Вы можете создать новый кошелек или импортировать уже существующий."),
