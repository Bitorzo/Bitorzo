...
class NumberUtil {
  ...
  /// Convert Satoshi to mBTC (with 3 digits after .)
  ///
  static String SatoshiToMilliBTC(String satoshi) {
    NumberFormat formatter = NumberFormat();
    formatter.minimumFractionDigits = 0;
    formatter.maximumFractionDigits = 3;
    return formatter.format(double.parse(satoshi) * 0.00001);
  }

  /// Convert  mBTC to satoshi

  static String MilliBTCToSatoshi(String raw) {
    return (double.parse(raw) * 100000).toStringAsFixed(0);
  }


  /// Convert  BTCtoMilliBTC
  static String BTCtoMilliBTC(String raw) {
    return (double.parse(raw) * 1000).toStringAsFixed(4);
  }


  /// Convert  BTC to satoshi

  static String BTCToSatoshi(String raw) {
    return (double.parse(raw) * 100000000).toStringAsFixed(0);
  }
