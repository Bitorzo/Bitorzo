...
class _ContactsListState extends State<ContactsList> {
  ...
  Future<void> _exportContacts() async {
    List<AppContact> contacts = await sl.get<DBHelper>().getContacts();
  ...
  Future<void> _importContacts() async {
    ...
    try {
      ...
      List<AppContact> contacts = List();
      List<AppContact> contactsToAdd = List();
      ...
      if (numSaved > 0) {
        ...
        EventTaxiImpl.singleton().fire(
            ContactModifiedEvent(contact: AppContact(name: "", address: "", phone:"")));
        UIUtil.showSnackbar(
  ...
  Widget buildSingleContact(BuildContext context, AppContact contact) {
    return FlatButton(
      onPressed: () {
