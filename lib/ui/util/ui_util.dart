...
import 'package:bitorzo_wallet_flutter/ui/util/exceptions.dart';
...
class UIUtil {
  static Widget threeLineAddressText(BuildContext context, String address,
    ...
    String stringPartThree = address.substring(22, 34);
  ...
  static Widget fullAddressText(BuildContext context, String address,
      {ThreeLineAddressTextType type = ThreeLineAddressTextType.PRIMARY,
        String contactName}) {
    print(address);
    String stringPartOne = address.substring(0);
    //String stringPartTwo = address.substring(12, 22);
    //String stringPartThree = address.substring(22, 34);
    //String stringPartFour = address.substring(44, 59);
    //String stringPartFour = "";
