                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: account.address != null
                            ? UIUtil.fullAddressText(context, account.address, type: ThreeLineAddressTextType.PRIMARY60)
                            : account.selected ? UIUtil.fullAddressText(context, StateContainer.of(context).wallet.address, type: ThreeLineAddressTextType.PRIMARY60) : SizedBox()
                            ,
                        ),
                        // Balance Text
                          ...
                          child: RichText(
                            ...
                            text: TextSpan(
                              ...
                              children: [
                                ...
                                TextSpan(
                                  text: NumberUtil.SatoshiToMilliBTC(account.balance == null ? StateContainer.of(context).wallet.accountBalance.toString() : account.balance),
