...
import 'package:bitorzo_wallet_flutter/ui/widgets/one_or_three_address_text.dart';
...
class
SendSheet extends StatefulWidget {
...
class _SendSheetState extends State<SendSheet> {
  ...
  String _contactUnusedPublicAddress = "1somethingwentverywrongdudelikevery";
  ...
  void initState() {
    ...
    if (widget.contact != null) {
      ...
      // FirebaseUtil.getContactUnusedPublicAddress(widget.contact.phone).then((result) {
      //  setState(() {_contactUnusedPublicAddress = result; });});
      _isContact = true;
                        ...
                        if (_isContact && validRequest) {
                          ...
                          sl
                            ...
                            if (contact == null) {
                              ...
                              setState(() {
                                _addressValidationText =
                                    AppLocalization.of(context).tempUnsupported;
                              });

                              /*
                              FirebaseUtil.getContactUnusedPublicAddress(contact.phone).then((result) {
                                  ...
                                  Sheets.showAppHeightNineSheet(
                                      ...
                                      widget: SendConfirmSheet(
                                          amountRaw: _localCurrencyMode
                                              ...
                                              : _rawAmount == null
                                              ? // NumberUtil.MilliBTCToSatoshi(
                                          _sendAmountController.text //)
                                              : _rawAmount,
                                          //destination: contact.address,
                                          destination: _contactUnusedPublicAddress,
                                          contact: contact,
                                          maxSend: _isMaxSend(),
                                ...
                                UIUtil.showSnackbar(AppLocalization
                                    .of(context)
                                    .noPulicKeysAvailableForContact, context);
                                Navigator.of(context).pop();
                              });
                    ...
                    children: <Widget>[
                      ...
                      AppButton.buildAppButton(
                        ...
                        if (scanResult == null) {
                          ...
                          AppContact contact = await FirebaseUtil.getContactWhosAdressBelongsTo(await sl
                              .get<DBHelper>().getContacts(), address.address);

                          // See if this address belongs to a contact
                          /*
                          AppContact contact = await sl
                              .get<DBHelper>()
  ...
  Widget _buildContactItem(AppContact contact) {
    return Column(
