...
class BitorzoTheme extends BaseTheme {
  ...
  static const red = Color(0xDDDD1100);

  Color cancel = red;
  Color cancel60 = red.withOpacity(0.6);
  Color cancel30 = red.withOpacity(0.3);
  Color cancel15 = red.withOpacity(0.15);
